...
export default function Login() {
  ...
  const handleOAuthLogin = (provider: 'google' | 'github' | 'linkedin') => {
    window.location.href = `http://localhost:3000/auth/oauth/${provider}`;
  };

  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 px-4 py-8 overflow-y-auto">
      <div className="max-w-md mx-auto space-y-8 bg-white p-8 rounded-xl shadow-lg mb-8">
        {/* Header */}
