...
import videoEditorRoutes from "./routes/videoEditor";
import videoEditorExportRoutes from "./routes/videoEditorExport";
import videoMergeRoutes from "./routes/videoMerge";
...
// Serve static files for uploads and output
...
app.route("/video-editor", videoEditorRoutes);
app.route("/video-export", videoEditorExportRoutes);
app.route("/video-merge", videoMergeRoutes);
